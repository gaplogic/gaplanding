...
<svg {width} {height} viewBox="0 0 1259.6 121.82">
	<defs>
		<linearGradient
			id="b"
			x1="359.51"
		...
		>
			<stop offset="0" stop-color="#fff480">
				<animate
					attributeName="stop-color"
					values="#fff480; #ffcc33; #fff480;"
					dur="4s"
					repeatCount="indefinite"
				/>
			</stop>
			<stop offset="1" stop-color="#8fffbc">
				<animate
					attributeName="stop-color"
					values="#8fffbc; #8ff7a7; #8fffbc"
					dur="4s"
	...
	<g style="clip-path:url(#a)">
		<path
			d="M88.46 244.9H0v-367.97h1171.14C674.03 60.91 88.46 244.9 88.46 244.9Z"
			style="fill:url(#b)"
		/>
		<path
			d="M1259.6 244.9H88.46C585.57 60.91 1171.14-123.07 1171.14-123.07h88.46V244.9Z"
			style="fill:url(#c)"
		/>
	</g>
</svg>
